...
{
    public class DivideApplicator : IApplicator
    {
        public static readonly NamedExpression DIVIDE = new NamedExpression("/");
...
//            Console.WriteLine("Attempt to subtract " + expression);
            ...
            return isDouble ? (IExpression)DoubleExpression.fromDouble(result) : (IExpression)IntegerExpression.fromInteger((int)Math.Floor(result));
        }
    }
}
